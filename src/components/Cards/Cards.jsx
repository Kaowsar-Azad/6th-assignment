...
export const Cards = ({AllCards ,cart , setcart , setselectType , selectType}) => {
  ...
  return (
    ...
    <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-2.5 ">
      {
        CardData.map((card) => {
          return(
            <div key={card.id} className='h-[440px] w-[340px] rounded-3xl relative shadow-2xl hover:scale-105'>
